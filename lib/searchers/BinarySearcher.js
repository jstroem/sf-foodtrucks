 ...
 * @param  {mixed} x The value to search for.
 * @return {mixed}  returns the first index of the object found. If the object with the value representation is not to be found the function returns `-(point+1)` where `point` is the smallest index that could contain the element (This is a string so it can represent -0).
 */
 ...
 * @param  {mixed} x The value to search for.
 * @return {mixed}  returns the last index of the object found. If the object with the value representation is not to be found the function returns `-point` where `point` is the largest index that could contain the element (This is a string so it can represent -0).
 */
